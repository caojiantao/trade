    ...
    <form id="ff" enctype="multipart/form-data">
        ...
        <div style="margin-bottom:15px;">
            ...
            <div style="display:inline-block;width:calc(100% - 100px);"><input class="easyui-textbox" id="order"
                                                                               name="order" style="width:100%;"></div>
        </div>
        <div style="margin-bottom:15px;">
            <div style="display:inline-block;width:80px;">广告链接：</div>
            <div style="display:inline-block;width:calc(100% - 100px);"><input class="easyui-textbox" id="url"
                                                                               name="url" style="width:100%;"></div>
        </div>
        <div style="margin-bottom:15px;">
