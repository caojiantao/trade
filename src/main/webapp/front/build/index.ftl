                ...
                <div class="box border _pro-new-txt fn-clear">
                    <ul>
                      <#list latestGoods as goods>
                          <li><i></i><a href="/goods.action?id=${goods.id?c}">${goods.updateTime?string("yyyy-MM-dd")}
                              &nbsp;${goods.name}</a></li>
                      </#list>
                    </ul>
                </div>
                ...
                <div class="_ems">
                    <div data-height="198" class="demo js-scroll-v">
                        <ul class="demo1 js-scroll1">
                          <#list emsList as ems>
                              <li class="js-item" style="overflow: hidden;text-overflow:ellipsis;white-space: nowrap;">
