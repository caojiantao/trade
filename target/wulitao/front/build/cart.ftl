							...
							<#list data as cart>
								<tr>
									<td class="td_pro td_btm_r">
										...
										<div class="td_img">
											<ul class="fn-clear">
												<li class="img"><a href="/goods.action?id=${cart.goods.id}"><img src="${cart.goods.logoUrl}" alt=""></a></li>
												<li class="txt"><a href="/goods.action?id=${cart.goods.id}">${cart.goods.title}</a></li>
											</ul>
										</div>
									</td>
