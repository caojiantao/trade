	...
	<body class="index">
		<div class="wrap-1000">
			...
			<div class="right top fn-clear">
							...
							<div class="box border _pro-new-txt fn-clear">
								<ul>
									<#list latestGoods as goods>
										<li><i></i><a href="/goods.action?id=${goods.id}">${goods.updateTime?string("yyyy-MM-dd")}&nbsp;${goods.title}</a></li>
									</#list>
								</ul>
							</div>
						</div>
				...
				<div class="_widget fn-clear">
					<div class="title"><i class="icon-item"></i><span>ブランド專區 </span><a href="" class="fn-right">もっと見る&gt;&gt;</a></div>
					<div class="content">
