...
-- ----------------------------
BEGIN;
INSERT INTO `admin` VALUES ('1', 'wulitaotao', '曹建涛', '1'), ('2', '1', '测试', '1'), ('3', 'test', '呵呵', 'test');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `advertisement` VALUES ('6', '3', 'http://www.wulitao.xyz', '/upload/advertisement/2_20171027184827.jpg', 'D:\\upload\\advertisement\\2_20171027184827.jpg'), ('7', '1', '123123214214', '/upload/advertisement/6_20171027184806.jpg', 'D:\\upload\\advertisement\\6_20171027184806.jpg'), ('11', '2', 'http://www.rufer.site', '/upload/advertisement/3_20171027184819.jpg', 'D:\\upload\\advertisement\\3_20171027184819.jpg');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `brand` VALUES ('1', '1', '品牌1', '1', '品牌', '', 'subscription', '1', '/upload/brand/IMG_0427_20170212221429.JPG', 'H:\\upload\\brand\\IMG_0427_20170212221429.JPG', '哈哈e&nbsp;'), ('7', '5', '品牌3', '24', 'sdaf', 'adfzxcv', 'asd23r', '1', '/upload/brand/IMG_0426_20170212233719.JPG', 'H:\\upload\\brand\\IMG_0426_20170212233719.JPG', '这是品牌3的内容。。。。。。'), ('9', '1', '品牌4', '2', '标题', '关键字', '描述', '1', '/upload/brand/taiyan_20161215000450.jpg', 'H:\\upload\\brand\\taiyan_20161215000450.jpg', '<img alt=\"\" src=\"http://kopi6.com/upload/image/20160310/20160310212514_5797.jpg\" /><span style=\"font-size:24px;\"><strong>ロレックス</strong></span><span>&nbsp;【</span><a href=\"http://www.kopi6.com/\"><span style=\"color:#000000;\">www.kopi6.com】</span></a><span></span>\r\n<p>\r\n	1908年、創業者のハンス・ウィルスドルフによって商標登録されたロレックス。圧倒的な人気・知名度を誇る、まさに\"機械式時計の王者\"です。<br />\r\nドレッシーな定番モデル「デイトジャスト」は、様々な文字盤・サイズ・素材で幅広いバリエーションを展開しています。<br />\r\n他方、スポーツモデルでは「エクスプローラー」「サブマリーナー」そして「コスモグラフ デイトナ」など、時計好きでなくとも耳にする大人気モデルを擁しています。<br />\r\n基本的なデザインを踏襲しつつ、飽きのこないデザインと、抜群の実用性・信頼性を誇っています。近年ではパラクロム・ヘアスプリングやセラミックベゼルなどの先端技術も積極的に取入れており、誰もがその動向から目を離せない､時計業界を牽引する存在です。&nbsp;\r\n</p>');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `category` VALUES ('8', '0', '0', '行业', 'スーパーコピー時計', null, null, null, null, null), ('9', '0', '0', '行业', 'スーパーコピーバッグ', null, null, null, null, null), ('10', '0', '0', '行业', 'スーパーコピー財布', null, null, null, null, null), ('11', '0', '0', '行业', 'その他商品', null, null, null, null, null), ('12', '10', '0', '品牌', '哈哈哈', null, null, null, null, null), ('13', '11', '0', '行业', '哈哈哈哈嗝', null, null, null, null, null), ('14', '13', '0', '行业', 'hello', null, null, null, null, null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `code_value` VALUES ('1', '1', '都道府県'), ('2', '1', '北海道'), ('3', '1', '青森県'), ('4', '1', '岩手県'), ('5', '1', '宮城県'), ('6', '1', '秋田県'), ('7', '1', '山形県'), ('8', '1', '福島県'), ('9', '1', '茨城県'), ('10', '1', '栃木県'), ('11', '1', '群馬県'), ('12', '1', '埼玉県'), ('13', '1', '千葉県\r'), ('14', '1', '東京都\r'), ('15', '1', '神奈川県'), ('16', '1', '新潟県\r'), ('17', '1', '富山県\r'), ('18', '1', '石川県\r'), ('19', '1', '福井県'), ('20', '1', '山梨県'), ('21', '1', '長野県\r'), ('22', '1', '岐阜県'), ('23', '1', '静岡県'), ('24', '1', '愛知県'), ('25', '1', '三重県\r'), ('26', '1', '滋賀県\r'), ('27', '1', '京都府\r'), ('28', '1', '大阪府\r'), ('29', '1', '兵庫県\r'), ('30', '1', '奈良県'), ('31', '1', '和歌山県'), ('32', '1', '鳥取県'), ('33', '1', '島根県\r'), ('34', '1', '岡山県\r'), ('35', '1', '広島県'), ('36', '1', '山口県'), ('37', '1', '徳島県'), ('38', '1', '香川県\r'), ('39', '1', '愛媛県\r'), ('40', '1', '高知県'), ('41', '1', '福岡県\r'), ('42', '1', '佐賀県\r'), ('43', '1', '長崎県\r'), ('44', '1', '熊本県'), ('45', '1', '大分県\r'), ('46', '1', '宮崎県'), ('47', '1', '鹿児島県\r'), ('48', '1', '沖縄県');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `goods` VALUES ('1', '4', 'NO.123', '商品1', '12346', b'1', b'1', '商品1售价1234', 'dfgdafg', '234213', 'H:\\upload\\goods\\taiyan_20161213235619.jpg', '/upload/goods/taiyan_20161213235619.jpg', '<p>\r\n	<a href=\"http://www.kopi6.com/protype/list.aspx?id=167\" target=\"_blank\"><strong><span style=\"color:#000000;\">シャネル スーパーコピー</span></strong></a><strong>&nbsp;J12 42 GMT H2126</strong><br />\r\n【&nbsp; 型&nbsp;&nbsp;&nbsp; 番&nbsp; 】H2126&nbsp;<br />\r\n【&nbsp; 機&nbsp;&nbsp;&nbsp; 械&nbsp; 】自動巻き&nbsp;<br />\r\n【 材&nbsp; 質&nbsp; 名 】セラミック&nbsp;<br />\r\n【 タ&nbsp; イ&nbsp; プ 】新品 メンズ&nbsp;<br />\r\n【文 字 盤 色 】ホワイト<br />\r\n【文字 盤 特徴】アラビア&nbsp;<br />\r\n【ケースサイズ】42.0mm&nbsp;<br />\r\n【&nbsp; 機&nbsp;&nbsp;&nbsp; 能&nbsp; 】2タイム表示<br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; デイト表示&nbsp;<br />\r\n【 付&nbsp; 属&nbsp; 品 】内 外箱<br />\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ギャランティー\r\n</p>\r\n<img alt=\"\" src=\"http://kopi6.com/upload/image/20160425/20160425121329_3120.jpg\" />', '2017-05-10 01:44:48', '0'), ('4', '8', '', 'test', '29000', b'1', b'0', '这是一个测试的商品', '关键字', 'tsaetsdf', 'H:\\upload\\goods\\3167854_105129_1_20170416234933.jpg', '/upload/goods/3167854_105129_1_20170416234933.jpg', '<div style=\"text-align:right;\">\r\n	<img src=\"http://localhost/plugins/editor/plugins/emoticons/images/21.gif\" border=\"0\" alt=\"\" /> \r\n</div>', '2017-05-02 23:25:22', '0'), ('5', '6', '', '妹纸', '19000', b'1', b'1', '这里是谭慧的直播间', '库里', '库里', 'H:\\upload\\goods\\IMG_0448_20170217230103.JPG', '/upload/goods/IMG_0448_20170217230103.JPG', '<span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span><span>下方</span>', '2017-03-19 20:56:05', null), ('9', '4', '123', '2', '99800', b'1', b'1', '123', '', '', '', null, '这里是内容，看清楚了', '2017-05-10 01:45:09', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `menu` VALUES ('1', '功能列表', '0', null), ('2', '商城管理', '0', null), ('3', '系统设置', '0', null), ('4', '信息单页', '1', null), ('5', '文章管理', '1', null), ('6', '用户反馈', '1', null), ('7', '广告反馈', '1', null), ('8', '会社概要', '4', '/backend/pageInfo.action?type=1'), ('9', '注文方法', '4', '/backend/pageInfo.action?type=2'), ('10', '重要事项', '4', '/backend/pageInfo.action?type=3'), ('11', '割引情报', '4', '/backend/pageInfo.action?type=4'), ('12', '注意事项', '4', '/backend/pageInfo.action?type=5'), ('13', '返品返金', '4', '/backend/pageInfo.action?type=6'), ('14', '营业时间', '4', '/backend/pageInfo.action?type=7'), ('15', '配送方式', '4', '/backend/pageInfo.action?type=8'), ('16', '文章列表', '5', '/backend/articleList.action'), ('17', '文章添加', '5', '/backend/articleAdd.action'), ('18', '用户反馈', '6', '/backend/feedback.action'), ('19', '广告列表', '7', '/backend/advertisementList.action'), ('20', '商品类型', '2', null), ('21', '商品管理', '2', null), ('22', '订单管理', '2', null), ('23', '用户管理', '2', null), ('24', 'EMS管理', '2', null), ('25', '商品行业', '20', null), ('26', '品牌类型', '20', null), ('27', '产品类型', '20', null), ('28', '行业列表', '25', '/backend/tradeList.action'), ('29', '行业添加', '25', '/backend/tradeAdd.action'), ('30', '品牌列表', '26', '/backend/brandList.action'), ('31', '品牌添加', '26', '/backend/brandAdd.action'), ('32', '产品列表', '27', '/backend/productList.action'), ('33', '产品添加', '27', '/backend/productAdd.action'), ('34', '商品列表', '21', '/backend/goodsList.action'), ('35', '商品添加', '21', '/backend/goodsAdd.action'), ('36', '订单列表', '22', '/backend/orderList.action'), ('37', '用户列表', '23', '/backend/userList.action'), ('38', '追踪列表', '24', '/backend/emsList.action'), ('39', '追踪添加', '24', '/backend/emsAdd.action'), ('40', '管理员管理', '3', ''), ('41', '网站信息', '3', ''), ('42', '管理员列表', '40', '/backend/admin.action'), ('43', '基本信息', '41', '/backend/website.action');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `product` VALUES ('4', '1', '产品1', '123', 'sfsad ', 'asdf asd', ' dsf ', 'H:\\upload\\product\\taiyan_20161213220930.jpg', '/upload/product/taiyan_20161213220930.jpg', '<img src=\"http://localhost/plugins/editor/plugins/emoticons/images/10.gif\" border=\"0\" alt=\"\" /><img src=\"http://localhost/plugins/editor/plugins/emoticons/images/20.gif\" border=\"0\" alt=\"\" />'), ('6', '7', '产品2', '3', '标题', '', '', 'H:\\upload\\product\\tanhui_20170213000159.jpg', '/upload/product/tanhui_20170213000159.jpg', '<span>阿斯顿发送到凡所大声道发送到发斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬asd</span><span>阿斯顿发送到凡所大声道发送到发斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬asd</span><span>阿斯顿发送到凡所大声道发送到发斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬asd</span><span>阿斯顿发送到凡所大声道发送到发斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬asd</span><span>阿斯顿发送到凡所大声道发送到发斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬阿斯蒂芬asd</span>'), ('8', '9', '产品4', null, '', '', '', 'H:\\upload\\product\\tanhui_20170213002013.jpg', '/upload/product/tanhui_20170213002013.jpg', '兄弟，这个是产品4');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `trade` VALUES ('1', 'スーパーコピー時計', '5'), ('4', 'スーパーコピーバッグ', '4'), ('5', 'スーパーコピー財布', '3'), ('6', 'その他商品', '2');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('14', '曹建涛', '111', 'wulitao', '4100000', '14', '光谷青年城', '13437104137', 'wulitaotao', '坑爹啊！~~~', '2017-04-24 23:37:16'), ('15', null, null, null, null, '1', null, null, 'test', null, null), ('16', '姓名', '123', '昵称', '431111', '4', '武汉', '13437104137', 'wulihong', '这里是备注', '2017-03-26 03:01:50'), ('17', null, '123', null, null, '0', null, null, '123', null, null), ('18', '姓名', '1234', '昵称', '邮编', '2', '住所', '1234567', '1234', '揭示板', null), ('19', '昵称', 'test', '', '', '15', '', '', '13437104137@163.com', '这是我的163测试账号，哈哈哈！', '2017-04-24 23:49:44'), ('20', null, null, null, null, '0', null, null, null, null, '2017-07-26 07:44:19'), ('21', null, null, null, null, '0', null, null, null, null, '2017-09-03 23:32:33');
COMMIT;
